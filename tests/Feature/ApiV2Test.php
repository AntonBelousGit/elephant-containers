...
class ApiV2Test extends TestCase
{
    ...
    {
        $response = $this->get('/api/v1/quote/rates/');
    ...
    {
        $response = $this->get('/api/v1/quote/rates/ESBCN');
    ...
    {
        $response = $this->get('/api/v1/quote/rates/ESBCN/USMIA1');
    ...
    {
        $response = $this->get('/api/v1/quote/rates/ESBCN/USMIA1/10');
    ...
    {
        $response = $this->get('/api/v1/quote/rates/ESBCN/ESMUS/10');
    ...
    {
        $response = $this->get('/api/v1/quote/rates/ESBCN/USMIA/10');
